...
export const translations = {
  zh: {
    ...
    hero: {
      ...
      tagline2: '商务英语 ·',
      tagline3: '内容运营',
      headline1: '我用语言、设计与AI，',
      headline2: '把好产品送到世界各地。',
      meta: '长沙 · 21 岁 · 商务英语 · 即将就业',
      ctaPrimary: '联系我',
      ctaSecondary: '查看项目',
      photoCaption: 'TAN QINGHUA · PORTRAIT',
      yearLabel: 'EST. 2004',
      basedIn: 'BASED IN CHANGSHA, CN',
  ...
  en: {
    ...
    hero: {
      eyebrow: '01 / Intro',
      tagline1: 'Foreign Trade ·',
      tagline2: 'Business English ·',
      tagline3: 'Content Ops',
      headline1: 'I move good products',
      headline2: 'across borders — with words, design & AI.',
      meta: 'Changsha · 21 · Business English · Available now',
    ...
    contact: {
      eyebrow: '06 / Contact',
      heading: 'Open to roles in foreign-trade sales —',
      headingTwo: 'and conversations beyond.',
      sub: 'Full-time, internship, or remote — all welcome.',
      copy: 'Click to copy',
      copied: 'Copied',
